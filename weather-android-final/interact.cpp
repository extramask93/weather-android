...
void Interact::RetrieveStations()
{
    ...
    QString url = "http://"+settings_.ip()+":"+QString::number(settings_.port())+"/GetStations";
...
{
    QString url = "http://"+settings_.ip()+":"+QString::number(settings_.port())+"/LogOut";
    HttpRequestInput input(url,"GET");
    HttpRequestWorker *worker = new HttpRequestWorker(this);
...
void Interact::updateDailyJSON()
{
    if(currentStation.first == "")
        return;
    worker_->disconnect();
    QString url = "http://"+settings_.ip()+":"+QString::number(settings_.port())+"/GetDaily";
    HttpRequestInput input(url,"GET");
