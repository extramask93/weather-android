...
#include "calendar.h"
Interact::Interact(QObject *parent, QQmlApplicationEngine &engine, MeasurementsModel *modell, LoginHandler *login, Station *currentStat):
    QObject{parent},engine_{engine}, model{modell}, login_{login}, currentStation{currentStat}
{
    worker_ = new HttpRequestWorker(nullptr);
